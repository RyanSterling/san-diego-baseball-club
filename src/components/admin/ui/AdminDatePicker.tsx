...
const AdminDatePicker = forwardRef<HTMLInputElement, AdminDatePickerProps>(
  (
    { label, error, includeTime = false, onChange, className = "", id, ...props },
    ref
  ) => {
    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          className={`w-full bg-white/5 border text-white px-4 py-3 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-teal/20 [color-scheme:dark] ${
            error
